...
mod tests {
    ...
    use crate::models::{Position, m_Position, Moves, m_Moves, Direction};
    ...
    fn contract_defs() -> Span<ContractDef> {
        [
            ContractDefTrait::new(@"capyspace", @"actions")
                .with_writer_of([dojo::utils::bytearray_hash(@"capyspace")].span())
        ]
            .span()
    }
